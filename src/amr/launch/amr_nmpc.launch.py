...
def generate_launch_description():
    ...
    robots = [
        {'name': 'amr1', 'x_pose': '-1.5', 'y_pose': '-0.5', 'z_pose': 0.01}
        # {'name': 'amr2', 'x_pose': '-1.5', 'y_pose': '0.5', 'z_pose': 0.01},
        # {'name': 'amr3', 'x_pose': '1.5', 'y_pose': '-0.5', 'z_pose': 0.01},
        # {'name': 'amr4', 'x_pose': '1.5', 'y_pose': '0.5', 'z_pose': 0.01},
        # ...
        # ...
        ]
    ...
    package_dir = get_package_share_directory('amr')
    ...
    map_server=Node(package='nav2_map_server',
        ...
        name='map_server',
        output='screen',
        parameters=[{'yaml_filename': os.path.join(get_package_share_directory('amr'), 'map', 'factory_map2.yaml'),
                     },],
    ...
    for robot in robots:
        ...
        spwan_amr = Node(
            ...
            arguments=[
                '-file', os.path.join(amr,'models', 'amr', 'model_nmpc.sdf'),
                '-entity', robot['name'],
        ...
        if last_action is None:
            ...
            spwan_amr_event = RegisterEventHandler(
            ...
            ld.add_action(spwan_amr_event)

        # Save last instance for next RegisterEventHandler
        last_action = spwan_amr
    ######################
